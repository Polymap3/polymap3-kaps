...
public class FlurstueckFuerEinzelnenVertragFilter
    ...
    public FlurstueckFuerEinzelnenVertragFilter( ILayer layer ) {
        super( FlurstueckFuerEinzelnenVertragFilter.class.getName(), layer, "einzelner Vertrag...", null, 10000, FlurstueckComposite.class );
    }
