...
public class VertraegeStabuFilter
    ...
    public Composite createControl( Composite parent, IFilterEditorSite site ) {
        ...
        site.addStandardLayout( site.newFormField( result, "Quartal", String.class,
                new PicklistFormField( new String[] { "1", "2", "3", "4" } ), new NotNullValidator(), "Quartal" ) );
        ...
        Map<String, GemeindeComposite> typen = repository().entitiesWithNames( GemeindeComposite.class );
    ...
    protected Query<VertragComposite> createFilterQuery( final IFilterEditorSite site, final KapsRepository repository ) {
        ...
        Integer quartal = null;
        try {
            quartal = Integer.parseInt( (String)site.getFieldValue( "Quartal" ) );
        }
        catch (Exception e) {
            showError( "Quartal fehlt", "Bitte wählen Sie ein Quartal aus." );
            return null;
        }
        Integer jahr = null;
        try {
            ...
            showError( "Jahr fehlt", "Bitte wählen Sie ein Jahr aus." );
            return null;
        }
        ...
        if (vExpr != null) {
            ...
            {
                Query<NutzungComposite> nutzungen = repository().findEntities( NutzungComposite.class,
                        null, 0, -1 );
            ...
            if (gemeinde != null) {
                ...
                Query<GemarkungComposite> gemarkungen = repository().findEntities(
                        GemarkungComposite.class, QueryExpressions.eq( gemarkungTemplate.gemeinde(), gemeinde ), 0,
                        -1 );
            ...
            Query<FlurstueckComposite> allFlurstuecke = repository
                    .findEntities( FlurstueckComposite.class, expr, 0, getMaxResults() );
